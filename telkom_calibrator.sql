...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2020 at 07:51 PM
...
INSERT INTO `cal_requests` (`id`, `lab`, `request_type`, `device_name`, `manufacturer`, `type`, `serial_number`, `capacity`, `made_in`, `test_reference`, `company_name`, `company_address`, `created`, `start_target`, `finished_target`, `actual_start`, `actual_finished`, `engineer_1`, `engineer_2`, `engineer_3`, `test_report`) VALUES
('022/132/QA/2020', 'CAB', 'QA', 'KABEL SERAT OPTIK SINGLE MODE BERKONSTRUKSI LOOSE TUBE UNTUK APLIKASI TANAM LANGSUNG (KSO DIRECT BURIED)', 'VOKSEL', 'NZDS C LF B WG LT ( G 655 C ) ', '', '4 to 96 CORE', 'Indonesia', 'STEL K-016-2013 Ver. 3.0', 'VOKSEL ELECTRIC, Tbk. PT.', 'JL. RAYA NAROGONG KM.16, CILEUNGSI, BOGOR\r\n', '2020-03-18', '2020-03-18', '2020-04-08', '2020-03-20', '2020-04-10', '970037', '970000', '201902060', ''),
('a', '', '', 'ab', 'a', 'a', '', '', '', '', 'a', 'a', '2020-03-26', '2020-03-26', '2020-04-02', '2020-03-27', '', '970037', '', '', '');
